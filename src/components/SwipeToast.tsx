...
export default function SwipeToast({
  ...
  const drag = useRef<{ id: number; startY: number; grab: number | null; moved: boolean; hist: [number, number][] } | null>(null);
  ...
  const latest = useRef<{ onClose?: typeof onClose; onAction?: typeof onAction; slideMs: number; inline: boolean }>({
    onClose,
    onAction,
    slideMs,
    inline
